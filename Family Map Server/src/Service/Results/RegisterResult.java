/**
 * A class that returns a register object to the gson magic.
 */
public class RegisterResult extends  Result {
   ...
   */
  public RegisterResult(Boolean success, String setAuthToken, String setUsername, String setPersonID) {
